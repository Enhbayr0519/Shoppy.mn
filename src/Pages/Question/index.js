...
import question from "../../images/pagesPoster/question.png"
      ...
      <>
        <div className="w-full flex flex-col justify-center items-center mt-8">
          <div className='w-full flex flex-col justify-center items-center text-center mt-4'>
            <img className='w-full xl:h-64 md:h-44 sm:h-32 h-full' src={question} alt=""/>
            <p className='xl:text-3xl md:text-2xl sm:text-xl text-sm font-bold text-center absolute ml-32 text-white'>ТҮГЭЭМЭЛ АСУУЛТУУД </p>
          </div>
